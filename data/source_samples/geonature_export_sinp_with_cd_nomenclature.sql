...
WITH jdd_acteurs AS (
    SELECT
        d_1.id_dataset
        , array_to_json(array_agg(DISTINCT jsonb_build_object('nom_organisme'
                    , orga.nom_organisme
                    , 'uuid_organism'
                    , orga.uuid_organisme
                    , 'nom_role'
	...
	JOIN ref_nomenclatures.t_nomenclatures nomencl ON
	    nomencl.id_nomenclature = act.id_nomenclature_actor_role
...
FROM
    ...
    JOIN gn_meta.t_acquisition_frameworks af ON td.id_acquisition_framework =
    ...
    LEFT JOIN ref_nomenclatures.t_nomenclatures n2 ON s.id_nomenclature_grp_typ
	= n2.id_nomenclature
    LEFT JOIN ref_nomenclatures.t_nomenclatures n3 ON
	s.id_nomenclature_behaviour = n3.id_nomenclature
    LEFT JOIN ref_nomenclatures.t_nomenclatures n4 ON
	s.id_nomenclature_obs_technique = n4.id_nomenclature
    ...
    LEFT JOIN ref_nomenclatures.t_nomenclatures n11 ON s.id_nomenclature_sex =
	n11.id_nomenclature
