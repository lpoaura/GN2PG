...
/* UPSERT INTO Synthese when type is "synthese_with_label */
        ...
        CREATE OR REPLACE FUNCTION gn2pg_import.fct_tri_c_upsert_data_to_geonature_with_nomenclature_label() RETURNS TRIGGER
            LANGUAGE plpgsql
        AS
        $func$
        DECLARE
...
/* UPSERT INTO Synthese when type is "synthese_with_cd_nomenclature" */
        ...
        CREATE OR REPLACE FUNCTION gn2pg_import.fct_tri_c_upsert_data_to_geonature_with_cd_nomenclature() RETURNS TRIGGER
            LANGUAGE plpgsql
        AS
        $func$
        DECLARE
